...
var colors = ['#16a085', '#27ae90', '#2c3e50', '#33cc12', '#e74c3c', '#9b59b6', '#FB6964', '#342224', "#472E32", "#BDBB99", "#77B1A9", "#73A857"];
var currentQuote = '',
    currentAuthor = '';
...
$(document).ready(function() {
    ...
    $('#tweet-quote').on('click', function() {
        if (!inIframe()) {
            ...
            //openURL('https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?summary=' + encodeURIComponent(currentQuote) + '&url=' + url + '&pics=' + picurl);
        }
    });
